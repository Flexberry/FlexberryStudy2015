...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SportivnyjRazryadE.aspx.cs" Inherits="IIS.Ипподром.СпортивныйРазрядE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Спортивный разряд</h2>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlРазрядЖокеяLabel" runat="server" Text="Разряд жокея" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlРазрядЖокея" runat="server">
</asp:TextBox>
