...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlМенеджер_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlМенеджер_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
