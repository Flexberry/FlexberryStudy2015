...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlМатериальноОтвественноеЛицоLabel" runat="server" Text="Материально отвественное лицо" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlМатериальноОтвественноеЛицо" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

<asp:RequiredFieldValidator ID="ctrlМатериальноОтвественноеЛицоValidator" runat="server" ControlToValidate="ctrlМатериальноОтвественноеЛицо"
ErrorMessage="Не указано: МатериальноОтвественноеЛицо" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlМатериальноОтвественноеЛицо_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlМатериальноОтвественноеЛицо_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
