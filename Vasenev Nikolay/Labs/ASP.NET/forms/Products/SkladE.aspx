...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКладовщик_ФИОLabel" runat="server" Text="ФИО" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlКладовщик_ФИО" runat="server" ReadOnly="true">
</asp:TextBox>
