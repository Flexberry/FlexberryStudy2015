...
namespace IIS.АСУ_Склад
{
    ...
    [View("НакладнаяE", new string[] {
            ...
            "МатериальноОтвественноеЛицо as \'Материально отвественное лицо\'",
            "МатериальноОтвественноеЛицо.ФИО as \'ФИО\'",
            "Заказ as \'Заказ\'",
    ...
    public class Накладная : IIS.АСУ_Склад.Документ
    {
        ...
        private IIS.АСУ_Склад.Сотрудник fМатериальноОтвественноеЛицо;
        ...
        /// Накладная.
        /// </summary>
        // *** Start programmer edit section *** (Накладная.МатериальноОтвественноеЛицо CustomAttributes)

        // *** End programmer edit section *** (Накладная.МатериальноОтвественноеЛицо CustomAttributes)
        [PropertyStorage(new string[] {
                "МатериальноОтвественноеЛицо"})]
        [NotNull()]
        public virtual IIS.АСУ_Склад.Сотрудник МатериальноОтвественноеЛицо
        {
            get
            {
                // *** Start programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Get start)

                // *** End programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Get start)
                IIS.АСУ_Склад.Сотрудник result = this.fМатериальноОтвественноеЛицо;
                // *** Start programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Get end)

                // *** End programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Set start)

                // *** End programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Set start)
                this.fМатериальноОтвественноеЛицо = value;
                // *** Start programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Set end)

                // *** End programmer edit section *** (Накладная.МатериальноОтвественноеЛицо Set end)
            }
        }
