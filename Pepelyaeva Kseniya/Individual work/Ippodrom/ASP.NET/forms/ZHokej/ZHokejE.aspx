...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="ZHokejE.aspx.cs" Inherits="IIS.Ippodrom.ЖокейE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlРазрядLabel" runat="server" Text="Разряд" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlРазряд" runat="server">
</asp:TextBox>
