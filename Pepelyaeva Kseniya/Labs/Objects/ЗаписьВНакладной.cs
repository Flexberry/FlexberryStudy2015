...
namespace IIS.АСУСклад
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.АСУСклад.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.АСУСклад.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.АСУСклад.Накладная Накладная
        {
            get
            {
                ...
                IIS.АСУСклад.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.АСУСклад.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        public IIS.АСУСклад.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.АСУСклад.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
