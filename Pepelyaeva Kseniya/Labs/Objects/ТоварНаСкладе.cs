...
namespace IIS.АСУСклад
{
    ...
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.АСУСклад.Склад fСклад;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.АСУСклад.Склад.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Склад"})]
        public virtual IIS.АСУСклад.Склад Склад
        {
            get
            {
                ...
                IIS.АСУСклад.Склад result = this.fСклад;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварНаСкладеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеE", typeof(IIS.АСУСклад.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.АСУСклад.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.АСУСклад.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.АСУСклад.Склад fСклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fСклад)))
        {
        }
        
        public IIS.АСУСклад.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.АСУСклад.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.АСУСклад.ТоварНаСкладе dataobject)
        {
