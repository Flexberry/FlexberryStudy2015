...
namespace IIS.АСУСклад
{
    ...
    [View("НакладнаяL", new string[] {
            ...
            "Заказ.Статус as \'Статус\'",
            "МатериальноОтветственноеЛицо.Фамилия as \'Фамилия\'"})]
    public class Накладная : IIS.АСУСклад.Документ
    {
        
        private IIS.АСУСклад.СостояниеНакладной fСтатус;
        ...
        private IIS.АСУСклад.Сотрудник fМатериальноОтветственноеЛицо;
        
        private IIS.АСУСклад.Заказ fЗаказ;
        
        private IIS.АСУСклад.DetailArrayOfЗаписьВНакладной fЗаписьВНакладной;
        ...
        public virtual IIS.АСУСклад.СостояниеНакладной Статус
        {
            get
            {
                ...
                IIS.АСУСклад.СостояниеНакладной result = this.fСтатус;
        ...
        [NotNull()]
        public virtual IIS.АСУСклад.Сотрудник МатериальноОтветственноеЛицо
        {
            get
            {
                ...
                IIS.АСУСклад.Сотрудник result = this.fМатериальноОтветственноеЛицо;
        ...
        public virtual IIS.АСУСклад.DetailArrayOfЗаписьВНакладной ЗаписьВНакладной
        {
            get
            {
                ...
                {
                    this.fЗаписьВНакладной = new IIS.АСУСклад.DetailArrayOfЗаписьВНакладной(this);
                }
                IIS.АСУСклад.DetailArrayOfЗаписьВНакладной result = this.fЗаписьВНакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НакладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяE", typeof(IIS.АСУСклад.Накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НакладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НакладнаяL", typeof(IIS.АСУСклад.Накладная));
                }
            }
        }
    }
