...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="TovarE.aspx.cs" Inherits="IIS.Individual_work_1.ТоварE" %>
...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlАртикулLabel" runat="server" Text="Артикул" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlАртикул" Type="Numeric" runat="server">
</ac:AlphaNumericTextBox>

<asp:RequiredFieldValidator ID="ctrlАртикулValidator" runat="server" ControlToValidate="ctrlАртикул"
ErrorMessage="Не указано: Артикул" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
