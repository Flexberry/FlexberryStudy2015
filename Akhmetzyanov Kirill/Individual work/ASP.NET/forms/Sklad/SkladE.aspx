...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SkladE.aspx.cs" Inherits="IIS.Individual_work_1.СкладE" %>
...
<asp:RequiredFieldValidator ID="ctrlВместимостьValidator" runat="server" ControlToValidate="ctrlВместимость"
ErrorMessage="Не указано: Вместимость" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
