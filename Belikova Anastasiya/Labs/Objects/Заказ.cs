...
namespace IIS.АСУ_Склад
{
    ...
    [View("ЗаказE", new string[] {
            ...
            "Менеджер.Фамилия",
            "Менеджер as \'Менеджер\'"}, Hidden=new string[] {
            "Менеджер.Фамилия"})]
    ...
    [View("ЗаказL", new string[] {
            ...
            "Номер as \'Номер\'",
            "ДатаЗаполнения as \'Дата заполнения\'",
            "ПрезентационныйАтрибут",
            "Менеджер.Фамилия as \'Менеджер\'",
            "Менеджер"}, Hidden=new string[] {
            "ПрезентационныйАтрибут",
            "Менеджер"})]
    public class Заказ : IIS.АСУ_Склад.Документ
    {
        ...
        /// ПрезентационныйАтрибут.
        /// </summary>
        // *** Start programmer edit section *** (Заказ.ПрезентационныйАтрибут CustomAttributes)

        // *** End programmer edit section *** (Заказ.ПрезентационныйАтрибут CustomAttributes)
        [ICSSoft.STORMNET.NotStored()]
        [StrLen(255)]
        [DataServiceExpression(typeof(ICSSoft.STORMNET.Business.MSSQLDataService), "cast(@Номер@ as varchar)+\' от \'+convert(varchar(10), @ДатаЗаполнения@, 104)")]
        public virtual string ПрезентационныйАтрибут
        {
            get
            {
                // *** Start programmer edit section *** (Заказ.ПрезентационныйАтрибут Get)
                return null;
                // *** End programmer edit section *** (Заказ.ПрезентационныйАтрибут Get)
            }
            set
            {
                // *** Start programmer edit section *** (Заказ.ПрезентационныйАтрибут Set)

                // *** End programmer edit section *** (Заказ.ПрезентационныйАтрибут Set)
            }
        }
