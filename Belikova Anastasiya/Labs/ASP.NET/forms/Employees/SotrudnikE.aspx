...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">СотрудникE</h2>
...
<asp:RequiredFieldValidator ID="ctrlТабельныйНомерValidator" runat="server" ControlToValidate="ctrlТабельныйНомер"
ErrorMessage="Не указано: ТабельныйНомер" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
