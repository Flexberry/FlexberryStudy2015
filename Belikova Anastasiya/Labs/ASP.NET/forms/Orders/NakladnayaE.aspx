...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlДатаВремяОтгрузкиLabel" runat="server" Text="Дата отгрузки" EnableViewState="False">
</asp:Label>
<div class="descTxt">
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlФИОПолучателяLabel" runat="server" Text="ФИО получателя" EnableViewState="False">
</asp:Label>
...
<asp:RequiredFieldValidator ID="ctrlДатаЗаполненияValidator" runat="server" ControlToValidate="ctrlДатаЗаполнения"
ErrorMessage="Не указано: ДатаЗаполнения" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlСтрокаНакладной" runat="server" ReadOnly="false" />
</div>
<br/>
