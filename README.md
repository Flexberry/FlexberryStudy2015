...
3. Написать интеграционные тесты для бизнес-серверов с использованием тестового фреймворка MSTest (необязательно):
  ...
  * При создании эеземпляра бизнес-сервера в тесте необходимо передать ему инстанцию сервиса данных, которая создана на основе информации из конфигурационного файла
