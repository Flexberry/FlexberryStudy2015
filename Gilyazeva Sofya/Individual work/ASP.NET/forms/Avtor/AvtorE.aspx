...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="AvtorE.aspx.cs" Inherits="IIS.Книги.АвторE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Автор</h2>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlАвторКнига" runat="server" ReadOnly="false" />
</div>
