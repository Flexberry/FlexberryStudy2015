...
namespace IIS.АСУ_Склад
{
    ...
    [View("ЗаписьВНакладнойE", new string[] {
            ...
            "Товар.Название"})]
    [MasterViewDefineAttribute("ЗаписьВНакладнойE", "МатериальноОтветственноеЛицо", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Фамилия")]
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Запись в накладной.
        /// </summary>
        // *** Start programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо CustomAttributes)

        // *** End programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо CustomAttributes)
        ...
        public virtual IIS.АСУ_Склад.Сотрудник МатериальноОтветственноеЛицо
        {
            get
            {
                // *** Start programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Get start)

                // *** End programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Get start)
                IIS.АСУ_Склад.Сотрудник result = this.fМатериальноОтветственноеЛицо;
                // *** Start programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Get end)

                // *** End programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Set start)

                // *** End programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Set start)
                this.fМатериальноОтветственноеЛицо = value;
                // *** Start programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Set end)

                // *** End programmer edit section *** (ЗаписьВНакладной.МатериальноОтветственноеЛицо Set end)
            }
        }
