...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="NakladnayaE.aspx.cs" Inherits="IIS.Склад.НакладнаяE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlБухгалтерLabel" runat="server" Text="Бухгалтер" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlБухгалтер" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

<asp:RequiredFieldValidator ID="ctrlБухгалтерValidator" runat="server" ControlToValidate="ctrlБухгалтер"
ErrorMessage="Не указано: Бухгалтер" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>

</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlБухгалтер_ФамилияLabel" runat="server" Text="Фамилия" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlБухгалтер_Фамилия" runat="server" ReadOnly="true">
</asp:TextBox>
