...
namespace IIS.Склад
{
    ...
    [View("ЗаписьВНакладнойE", new string[] {
            ...
            "Товар.Наименование"})]
    [MasterViewDefineAttribute("ЗаписьВНакладнойE", "Товар", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Наименование")]
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Склад.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Склад.Накладная.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.Склад.Накладная Накладная
        {
            get
            {
                ...
                IIS.Склад.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.Склад.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Склад.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.Склад.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.Склад.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.Склад.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.Склад.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Склад.ЗаписьВНакладной dataobject)
        {
