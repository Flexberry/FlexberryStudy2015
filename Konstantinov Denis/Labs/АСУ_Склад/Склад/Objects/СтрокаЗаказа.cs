...
namespace IIS.Склад
{
    ...
    [View("СтрокаЗаказаE", new string[] {
            ...
            "Товар.Наименование"})]
    [MasterViewDefineAttribute("СтрокаЗаказаE", "Товар", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Наименование")]
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Склад.Заказ.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.Склад.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Склад.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.Склад.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.Склад.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Склад.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.Склад.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Склад.СтрокаЗаказа dataobject)
        {
