...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="EmployeeE.aspx.cs" Inherits="IIS.indiv_Firm.EmployeeE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Employee</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlspouseLabel" runat="server" Text="Spouse" EnableViewState="False">
</asp:Label>
<asp:CheckBox ID="ctrlspouse" CssClass="descTxt" runat="server" Text=""/>
</div>
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlmaleLabel" runat="server" Text="Male" EnableViewState="False">
</asp:Label>
<asp:CheckBox ID="ctrlmale" CssClass="descTxt" runat="server" Text=""/>
</div>
