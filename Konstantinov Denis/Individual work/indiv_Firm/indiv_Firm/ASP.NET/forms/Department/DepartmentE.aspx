...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="DepartmentE.aspx.cs" Inherits="IIS.indiv_Firm.DepartmentE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Department</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlEmployeeLabel" runat="server" Text="Employee" EnableViewState="False">
</asp:Label>
<ac:MasterEditorAjaxLookUp ID="ctrlEmployee" CssClass="descTxt" runat="server" ShowInThickBox="True" Autocomplete="true" />

<asp:RequiredFieldValidator ID="ctrlEmployeeValidator" runat="server" ControlToValidate="ctrlEmployee"
ErrorMessage="Не указано: Employee" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlEmployeeInDepartment" runat="server" ReadOnly="false" />
</div>
