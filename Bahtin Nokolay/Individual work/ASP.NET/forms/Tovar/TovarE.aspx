...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="TovarE.aspx.cs" Inherits="IIS.Indiv_Bahtin.ТоварE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlНомерАртикулLabel" runat="server" Text="Номер артикул" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlНомерАртикул" Type="Numeric" runat="server">
