...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlтовараLabel" runat="server" Text="Товара" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlтовара" Type="Numeric" runat="server">
