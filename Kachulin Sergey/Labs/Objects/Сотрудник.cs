...
namespace IIS.АСУ_Склад
{
    ...
    [View("СотрудникE", new string[] {
            "ТабельыйНомер as \'Табельый номер\'",
            "Фамилия as \'Фамилия\'",
            "Имя as \'Имя\'",
    ...
    public class Сотрудник : ICSSoft.STORMNET.DataObject
    {
        ...
        /// ТабельыйНомер.
        /// </summary>
        // *** Start programmer edit section *** (Сотрудник.ТабельыйНомер CustomAttributes)

        // *** End programmer edit section *** (Сотрудник.ТабельыйНомер CustomAttributes)
        public virtual int ТабельыйНомер
        {
            get
            {
                // *** Start programmer edit section *** (Сотрудник.ТабельыйНомер Get start)

                // *** End programmer edit section *** (Сотрудник.ТабельыйНомер Get start)
                int result = this.fТабельыйНомер;
                // *** Start programmer edit section *** (Сотрудник.ТабельыйНомер Get end)

                // *** End programmer edit section *** (Сотрудник.ТабельыйНомер Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Сотрудник.ТабельыйНомер Set start)

                // *** End programmer edit section *** (Сотрудник.ТабельыйНомер Set start)
                this.fТабельыйНомер = value;
                // *** Start programmer edit section *** (Сотрудник.ТабельыйНомер Set end)

                // *** End programmer edit section *** (Сотрудник.ТабельыйНомер Set end)
            }
        }
