...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SemestrE.aspx.cs" Inherits="IIS.Lectures.СеместрE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Семестр</h2>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlПредметВСеместре" runat="server" ReadOnly="false" />
</div>
