...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="PredmetE.aspx.cs" Inherits="IIS.Lectures.ПредметE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlКоличествоЧасовИзученияLabel" runat="server" Text="Количество часов изучения" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlКоличествоЧасовИзучения" Type="Numeric" runat="server">
