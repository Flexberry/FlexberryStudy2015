...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="PlatyozhkaE.aspx.cs" Inherits="IIS.Электронный_Магазин.ПлатёжкаE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Платёжка</h2>
...
<div style="clear: left">
	<ac:AjaxGroupEdit ID="ctrlСтрокаИзПлатёжки" runat="server" ReadOnly="false" />
</div>
<br/>
