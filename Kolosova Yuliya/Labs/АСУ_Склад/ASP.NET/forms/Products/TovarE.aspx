...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlЕденицаИзмеренияLabel" runat="server" Text="Еденица измерения" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlЕденицаИзмерения" runat="server">
</asp:TextBox>
