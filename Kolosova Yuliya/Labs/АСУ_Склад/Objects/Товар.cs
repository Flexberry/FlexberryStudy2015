...
namespace IIS.АСУ_Склад
{
    ...
    [View("ТоварE", new string[] {
            ...
            "ЕденицаИзмерения as \'Еденица измерения\'",
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private string fЕденицаИзмерения;
        ...
        /// ЕденицаИзмерения.
        /// </summary>
        // *** Start programmer edit section *** (Товар.ЕденицаИзмерения CustomAttributes)

        // *** End programmer edit section *** (Товар.ЕденицаИзмерения CustomAttributes)
        [StrLen(255)]
        public virtual string ЕденицаИзмерения
        {
            get
            {
                // *** Start programmer edit section *** (Товар.ЕденицаИзмерения Get start)

                // *** End programmer edit section *** (Товар.ЕденицаИзмерения Get start)
                string result = this.fЕденицаИзмерения;
                // *** Start programmer edit section *** (Товар.ЕденицаИзмерения Get end)

                // *** End programmer edit section *** (Товар.ЕденицаИзмерения Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Товар.ЕденицаИзмерения Set start)

                // *** End programmer edit section *** (Товар.ЕденицаИзмерения Set start)
                this.fЕденицаИзмерения = value;
                // *** Start programmer edit section *** (Товар.ЕденицаИзмерения Set end)

                // *** End programmer edit section *** (Товар.ЕденицаИзмерения Set end)
            }
        }
